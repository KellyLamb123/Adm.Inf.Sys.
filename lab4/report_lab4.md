...
Попробовали добавить заметку «После failover». Она появилась в таблице с идентификатором 4015, ниже видны записи 4001 и 4000 от предыдущей нагрузки. Запись снова работает, небольшой хайп 👍
